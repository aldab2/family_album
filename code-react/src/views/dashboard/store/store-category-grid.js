                        ...
                        <Card>
                           ...
                           <Card.Body>
                              <Form.Check className="form-check d-block mb-2">
                                 ...
                                 <Form.Check.Label  htmlFor="customCheck1">All Categories</Form.Check.Label>
                              </Form.Check>
                              <Form.Check className="form-check d-block mb-2">
                                 <Form.Check.Input type="checkbox" id="customCheck2"/>
                                 <Form.Check.Label  htmlFor="customCheck2">PSD Templates</Form.Check.Label>
                              </Form.Check>
                              <Form.Check className="form-check d-block mb-2">
                                 <Form.Check.Input type="checkbox" id="customCheck3"/>
                                 <Form.Check.Label  htmlFor="customCheck3">HTML Templates</Form.Check.Label>
                              </Form.Check>
                              <Form.Check className="form-check d-block mb-2">
                                 <Form.Check.Input type="checkbox" id="customCheck4"/>
                                 <Form.Check.Label  htmlFor="customCheck4">WP Templates</Form.Check.Label>
                              </Form.Check>
                              <Form.Check className="form-check d-block mb-2">
                                 <Form.Check.Input type="checkbox" id="customCheck5"/>
                                 <Form.Check.Label  htmlFor="customCheck5">Stream Packs</Form.Check.Label>
                              </Form.Check>
                              <Form.Check className="form-check d-block">
                                 <Form.Check.Input type="checkbox" id="customCheck6"/>
                                 <Form.Check.Label  htmlFor="customCheck6">Logos and Badges</Form.Check.Label>
                              </Form.Check>
                           </Card.Body>
                        </Card>
                        <Card>
